...
import { Permissions2RolesUncheckedUpdateManyWithoutRoleInput } from '../permissions-2-roles/permissions-2-roles-unchecked-update-many-without-role.input';
...
export class RoleUncheckedUpdateInput {
    ...
    @HideField()
    permissions?: Permissions2RolesUncheckedUpdateManyWithoutRoleInput;
}
