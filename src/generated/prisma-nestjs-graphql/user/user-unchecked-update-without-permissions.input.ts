...
import { Roles2UsersUncheckedUpdateManyWithoutUserInput } from '../roles-2-users/roles-2-users-unchecked-update-many-without-user.input';
...
export class UserUncheckedUpdateWithoutPermissionsInput {
    ...
    @HideField()
    roles?: Roles2UsersUncheckedUpdateManyWithoutUserInput;
}
