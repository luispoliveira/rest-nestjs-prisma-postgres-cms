...
} from "src/generated/prisma-nestjs-graphql/user/user-order-by-with-relation.input";
...
export class UsersResolver extends BaseResolver {
  ...
  UserGetUsers(
    ...
    @Args("orderBy", { nullable: true }) userOrderByWithRelationInput: UserOrderByWithRelationInput,
  ...
  @Query(returns => User)
  UserGetUser(@Args("userWhereUnique") userWhereUniqueInput: UserWhereUniqueInput) {
    return this.usersService.findOne(userWhereUniqueInput);
  }

  @Mutation(returns => User)
  UserCreateUser(@Args("userCreateInput") userCreateInput: UserCreateInput,
  ...
  @Mutation(returns => User)
  UserUpdateUser(@Args({ name: "userId", type: () => Int }) userId: number,
  ...
  @Mutation(returns => User)
  UserAddRole(@Args({ name: "userId", type: () => Int }) userId: number,
  ...
  @Mutation(returns => User)
  UserRemoveRole(@Args({ name: "userId", type: () => Int }) userId: number,
             @Args({ name: "roleId", type: () => Int }) roleId: number,
             @GqlGetUser() user: User) {
    return this.usersService.update({
      where: { id: userId },
  ...
  @Mutation(returns => User)
  UserAddPermission(@Args({ name: "userId", type: () => Int }) userId: number,
  ...
  @Mutation(returns => User)
  UserRemovePermission(@Args({ name: "userId", type: () => Int }) userId: number,
                   @Args({ name: "permissionsId", type: () => Int }) permissionId: number,
                   @GqlGetUser() user: User) {
    return this.usersService.update({
      where: { id: userId },
