...
export class AuthController {
  ...
  async signUp(@Body() createUserDto: CreateUserDto, @Request() request) {
    ...
    this.logger.audit(LogTypes.log, "Auth:signUp accessed", createUserDto.username, {
      route: request.url,
  ...
  async recoverPassword(@Body() recoverDto: RecoverDto, @Request() request) {
    this.logger.audit(LogTypes.log, "Auth:recoverPassword accessed", recoverDto.email, {
      route: request.url,
